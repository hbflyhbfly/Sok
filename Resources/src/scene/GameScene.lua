...
function createGameScene(level)
    ...
    local function init()
        ...
        CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile("res/texture/level3_objects.plist")
        CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile("res/texture/level4_objects.plist")
