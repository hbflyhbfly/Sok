...
local CONST = base_util:tableReadOnly(SPEED_TABLE)
...
function Background:createBackgroundLayer()
	...
	function initContent( )
		...
		--createbgObject("res/texture/move_2.png","res/texture/move_2.png",CONST.BACKGROUND_SPEED3,0)
		--createbgObject("res/texture/move_mg_3.png","res/texture/move_mg_4.png",CONST.BACKGROUND_SPEED3,_visibleSize.height*0.65)
    ...
    function createbgObject( bgObject1,bgObject2,speed,offsetY )
    	...
    	for i=0,1 do
			...
			bgObject:setAnchorPoint(ccp(0,0))
